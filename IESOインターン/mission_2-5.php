...
<p>編集要請</p>
<p>投稿番号 <input type="text" name="e_number"><br></p>
...
//投稿番号比較
	foreach ((array)$dataArr as $edit ){
		if( $edit["No."] == $e_number){
                for($h = 0; $h < count($edit); $h++){
                    $simEdit[$h] = mb_substr(trim($edit[$h]), 1, -1);
		}
		}
	}
